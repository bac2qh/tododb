...
impl CatppuccinFrappe {
    ...
    pub const MANTLE: Color = Color::Rgb(41, 44, 60);    // #292c3c  
    pub const CRUST: Color = Color::Rgb(35, 38, 52);     // #232634
    ...
    pub const SURFACE1: Color = Color::Rgb(65, 72, 104); // #414968
    ...
    pub const SKY: Color = Color::Rgb(153, 209, 219);      // #99d1db
    ...
    pub const MAROON: Color = Color::Rgb(234, 153, 156);   // #ea999c
    ...
    pub const FLAMINGO: Color = Color::Rgb(238, 190, 190); // #eebebe
    pub const ROSEWATER: Color = Color::Rgb(242, 213, 207); // #f2d5cf
